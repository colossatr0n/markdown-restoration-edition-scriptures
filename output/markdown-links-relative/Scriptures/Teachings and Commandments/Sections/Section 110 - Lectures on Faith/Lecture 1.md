[<< Lecture Preface](Lecture%20Preface.md)  |  [Lecture 2 >>](Lecture%202.md)
...
###### 6
Agreeably to this order we have first to show what faith is.

###### 7
The author of the epistle to the Hebrews, in the eleventh chapter of that epistle, and first verse, [Heb. 1:36], gives the following definition of the word faith:
